...
// The build script emits a static archive. Explicitly request static linkage
// so Android's linker does not search for a shared `libsimsimd.so`.
#[link(name = "simsimd", kind = "static")]
extern "C" {
